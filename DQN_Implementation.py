...
class QNetwork:
    ...
    def __init__(self, environment_name):
        ...
        # define any training operations
        # and optimizers here, initialize your variables, or alternately
...
class Replay_Memory:
    ...
    def __init__(self, memory_size=50000, burn_in=10000):
        ...
        # randomly initialized agent. Memory size is the maximum size after
        # which old elements in the memory are replaced.
...
class DQN_Agent:
    ...
    # (2) Create a function that constructs a policy from the Q values
    ...
    def __init__(self, environment_name, render=False):
        ...
        # as well as training parameters - number of episodes / iterations,
        # etc.
    ...
    def train(self):
        ...
        # If training without experience replay_memory, then you will
        # interact with the environment
        # in this function, while also updating your network parameters.

        # If you are using a replay memory, you should interact with
        # environment here, and store these
